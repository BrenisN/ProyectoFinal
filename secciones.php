...
function foot(){
    echo'
        ...
        <div class="iconos22">
          ...
          <img
            class="logo-registrado-icon22"
            alt=""
            src="./imagenes/logo-registrado@2x.png"
          />

          <div class="repar22">REP.AR</div>
          <img
            class="logo-facebook-icon22"
            alt=""
            src="./imagenes/logo-facebook@2x.png"
          />

          <img class="logo-ig-icon22" alt="" src="./imagenes/logo-ig@2x.png" />

          <img
            class="logo-twitter-icon22"
            alt=""
            src="./imagenes/logo-twitter@2x.png"
          />
        </div>';}
...
function nav(){
        ...
        <div class="hacen-envios">¿Hacen envios?</div>
        <div class="hacemos-envios-a">
          Hacemos envios a todo el país con el expreso que quieras
        </div>
        <div class="tienen-compra-minima">¿Tienen compra minima?</div>
        <div class="podes-combinar-entre">
          Podes combinar entre diferentes articulos. Monto: $50000
        </div>
        <div class="cmo-pago">¿Cómo pago?</div>
